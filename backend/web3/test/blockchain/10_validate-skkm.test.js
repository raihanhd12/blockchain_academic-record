...
describe("Validating Student Activity Credit in the Activity Credit Contract", function () {
    ...
    beforeEach(async function () {
        ...
        // Adding users with roles Student and Departmental Student Association
        ...
        for (let i = 1; i <= 5; i++) {
            ...
            // Verify Activity Credit for validation testing
        ...
        for (let i = 0; i < 5; i++) {
            try {
                ...
                tx = await skkm.connect(departmentStudentAssociation).validateSKKM(
                    ...
                    10 * (i + 1)
                ); // Validate Activity Credit with the corresponding ID
